export class Complex {
    ...
    subtract = (ops: Complex) => new Complex(ops.realNumber - this.realNumber, ops.imaginaryNumber - this.imaginaryNumber);

    add = (ops: Complex) => new Complex(ops.realNumber + this.realNumber, ops.imaginaryNumber + this.imaginaryNumber);

    multiply = (ops: Complex) => new Complex(ops.realNumber * this.realNumber, ops.imaginaryNumber * this.imaginaryNumber);

    divide = (ops: Complex) => new Complex(ops.realNumber / this.realNumber, ops.imaginaryNumber / this.imaginaryNumber);
}
...
export const TwoEquation = (a1: Complex, a2: Complex, a: Complex, b1: Complex, b2: Complex, b: Complex) => [
...
export const Threeequation = (a: Complex[], b: Complex[], c: Complex[]) => {
