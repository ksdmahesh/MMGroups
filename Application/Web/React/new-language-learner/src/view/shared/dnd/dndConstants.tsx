...
import { LeftBarItems } from '../../../models/renderViewConstants';
...
export const CloneDroppedItem = styled(DroppedItem)`
  + div {
    display: ${(props: { isDragging?: boolean }) => (props.isDragging ? 'none !important' : 'flex !important')};
  }
`;
...
export const List = styled.div`
  border: 1px ${(props: { isDraggingOver?: boolean }) => (props.isDraggingOver ? 'dashed #000' : 'solid #ddd')};
  background: #fff;
